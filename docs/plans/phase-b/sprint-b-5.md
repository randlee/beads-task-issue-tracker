...
impl CliBackend for BdCli {
    fn binary(&self) -> &str { self.inv.binary_ref() }          // `CliInvoker::binary_ref(&self) -> &str` alongside `binary() -> String`, or store the name in BdCli
