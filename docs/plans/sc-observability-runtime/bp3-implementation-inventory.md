...
Generated from implementation revision `51fb22c6873b12c541b20b7f909110abb457c240`. Do not edit this file by
...
| Symbol | Complete public shape at `51fb22c6873b12c541b20b7f909110abb457c240` | Target disposition |
| --- | --- | --- |
...
Source-derived counts: 33 public declarations, 5 impl headers, 5 derive lists.
...
- L131 public declaration: `pub use handle::{ block_next_shutdown_save, fail_next_shutdown_coordinator_reservation, notify_next_wait_stopped, };`
- L136 public declaration: `pub use health::fail_next_health_snapshot;`
- L138 public declaration: `pub use sc_observability_types::{ AdmissionOutcome, Level as EventLevel, LevelChange, LevelChangeError, LevelChangeSource, LevelState, LogEvent, LogQuery, LogSnapshot, OperationDiagnostic, };`
- L147 public declaration: `pub use sc_observability_log_macros::{debug, error, event, info, instrument, trace, warn};`
- L155 derive: `#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]`
- L157 public declaration: `pub struct Level(LevelInner);`
- L159 derive: `#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]`
- L168 impl: `impl Level {`
- L170 public declaration: `pub const TRACE: Level = Level(LevelInner::Trace);`
- L172 public declaration: `pub const DEBUG: Level = Level(LevelInner::Debug);`
- L174 public declaration: `pub const INFO: Level = Level(LevelInner::Info);`
- L176 public declaration: `pub const WARN: Level = Level(LevelInner::Warn);`
- L178 public declaration: `pub const ERROR: Level = Level(LevelInner::Error);`
- L181 impl: `impl From<Level> for sc_observability_types::Level {`
- L196 derive: `#[derive(Debug, Clone)]`
- L197 public declaration:
```rust
...
```
- L208 derive: `#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, serde::Serialize, serde::Deserialize)]`
- L209 public declaration:
```rust
...
```
- L219 impl: `impl DroppedEvents {`
- L234 public declaration: `pub fn get(&self, cause: DropCause) -> u64 {`
- L248 public declaration: `pub fn total(&self) -> u64 {`
- L263 public declaration: `pub const DEFAULT_DROP_SHUTDOWN_TIMEOUT: Duration = Duration::from_secs(2);`
- L274 derive: `#[derive(Debug)]`
- L275 public declaration:
```rust
pub struct LogGuard {
...
```
- L281 impl: `impl LogGuard {`
- L287 public declaration: `pub fn control(&self) -> LogControl {`
- L299 public declaration: `pub fn elevate_level( &mut self, level: LevelFilter, source: LevelChangeSource, ) -> Result<LevelChange, LevelChangeError> {`
- L316 public declaration: `pub fn reset_level( &mut self, source: LevelChangeSource, ) -> Result<LevelChange, LevelChangeError> {`
- L332 public declaration: `pub fn flush(&self, timeout: Duration) -> Result<(), FlushError> {`
- L349 public declaration: `pub fn shutdown(mut self, timeout: Duration) -> Result<(), ShutdownError> {`
- L356 public declaration: `pub fn dropped_events(&self) -> DroppedEvents {`
- L363 public declaration: `pub fn active_log_path(&self) -> Option<&Path> {`
- L372 public declaration: `pub fn health(&self) -> Result<BridgeHealthReport, ControlError> {`
- L377 impl: `impl Drop for LogGuard {`
- L407 public declaration: `pub fn init(config: LoggerConfig, options: BridgeOptions) -> Result<LogGuard, InitError> {`
- L525 public declaration:
```rust
pub mod __private {
...
Source-derived counts: 4 public declarations, 0 impl headers, 3 derive lists.

- L19 public declaration: `pub const BRIDGE_HEALTH_SCHEMA_VERSION: u32 = 1;`
- L22 derive: `#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]`
- L23 public declaration:
```rust
...
```
- L43 derive: `#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]`
- L45 public declaration:
```rust
...
```
- L53 derive: `#[derive(Debug)]`
- L69 public declaration: `pub fn fail_next_health_snapshot() {`
